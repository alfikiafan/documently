(function ($) {
    $.fn.floatingWhatsApp = function (options) {
        ...
        if (settings.showPopup) {
            ...
            $closeBtn.addClass('closePopUp').html('&times;');
...
$(function () {
    $('#myButton').floatingWhatsApp({
        phone: '6281807031625',
        popupMessage: 'Documently siap membantu Anda. Jika Anda membutuhkan layanan pengetikan rapi dan terjangkau, silakan chat untuk menghubungi Admin',
        message: "Halo kak, saya ingin memesan jasa ketik",
        showPopup: true,
        showOnIE: false,
